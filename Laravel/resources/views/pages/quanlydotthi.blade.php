...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    ...
    <li class="active"><a href="quanlydotthi"><i class="icon icon-list"></i> <span>Quản lý đợt thi</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Quản lý đợt thi</a> </div>
  </div>
  <div class="container-fluid">
    <hr>
    <div class="row-fluid">
      <div class="span12">
	  	<button class="btn btn-success btn-mini" id="taodotthi">Tạo đợt thi mới</button>
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>Danh sách đợt thi</h5>
          </div>
...
@foreach($dotthi as $dt)
                <tr class="gradeX">
                  <td>{!! $dt->tendotthi !!}</td>
                  <td>{!! $dt->thoigianbatdau !!}</td>
                  <td>{!! $dt->thoigianketthuc !!}</td>
                <?php
                if($dt->trangthai=='1'){
                ?>
...
<link rel="stylesheet" href="public/admin/css/css-popup/cssadminquanlydotthi.css">
...
@endif   -->
        <form id="signupforms" name="signupforms" class="signupforms" method="post" action="{!!route('themdotthi')!!}" >
            <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Tên đợt thi</b></div>
                 <input type="text"  id="txt" name="txttendotthi"  />  
            ...
            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Thời gian băt đầu</b></div>
              <input type="date"  id="txt" name="txtthoigianbatdau"  />  
                </select>  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Thời gian kết thúc</b></div>
              <input type="date"  id="txt" name="txtthoigianketthuc"  />  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

              <button type="submit"  name="btnthem" class="btnthem">Thêm</button>
              <button  class="btnthoat" id="btnthoat">Thoát</button>
          </form>
        </div>
