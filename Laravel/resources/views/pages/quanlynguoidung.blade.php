...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-th"></i>Tables</a>
  <ul>
    ...
    <li class="active"><a href="quanlynguoidung"><i class="icon icon-group"></i> <span>Quản lý người dùng</span></a></li>
   
  </ul>
</div>
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Quản lý người dùng</a> </div>
  </div>
  <div class="container-fluid">
    <hr>
    <div class="row-fluid">
      <div class="span12">
	  	<button class="btn btn-success btn-mini" id="taonguoidung">Tạo người dùng mới</button>
...
@endif   -->
        <form id="signupforms" name="signupforms" class="signupforms" method="post" action="{!!route('themnguoidung')!!}" >
            <input type="hidden" name="_token" value="{!! csrf_token() !!}" />
            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Tên đăng nhập</b></div>
                 <input type="text"  id="txt" name="txttendangnhap"  />  
            ...
            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Mật khẩu</b></div>
              <input type="password"  id="txt" name="txtpassword"  />  
                </select>  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Họ tên</b></div>
              <input type="text"  id="txt" name="txthoten"  />  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Mssv</b></div>
              <input type="text"  id="txt" name="txtmssv"  />  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Giới tính</b>
            ...
            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Lớp</b></div>
              <input type="text"  id="txt" name="txtlop"  />  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

            <div class="ngaysoan" >
              <div class="ngaysoan"><b>Ngày sinh</b></div>
              <input type="date"  id="txt" name="txtngaysinh"  />  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

             <div class="ngaysoan" >
              <div class="ngaysoan"><b>Số điện thoại</b></div>
              <input type="text"  id="txt" name="txtsodienthoai"  />  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

             <div class="ngaysoan" >
              <div class="ngaysoan"><b>Email</b></div>
              <input type="text"  id="txt" name="txtemail"  />  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

             <div class="ngaysoan" >
              <div class="ngaysoan"><b>Hình đại diện</b></div>
              <input type="text"  id="txt" name="txthinhdaidien"  />  
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>

             <div class="ngaysoan" >
              <div class="ngaysoan"><b>Quyền</b></div>
              <select id="txt" name="cbbquyen">
          @foreach($quyen as $q)
                  <option value="{!! $q->maquyen !!}">{!! $q->tenquyen !!}</option>
          @endforeach
              </select> 
              <!-- {!! $errors->first('txttenbang') !!} -->
            </div>
