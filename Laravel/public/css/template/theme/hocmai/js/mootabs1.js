var mootabs = new Class({	
	...
	_getContent: function(){
        ...
        var str=this.options.ajaxUrl;
		if(str.search(/\?/) !=-1){
			var tabRequest = new Ajax(this.options.ajaxUrl + '&tab=' + encodeURIComponent(this.activeTitle.getProperty('title')), this.options.ajaxOptions);
		}else{
			var tabRequest = new Ajax(this.options.ajaxUrl + '?tab=' + encodeURIComponent(this.activeTitle.getProperty('title')), this.options.ajaxOptions);
