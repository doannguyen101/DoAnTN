...
var td_history = {
    ...
    get_mod_rewrite_base_url: function () {
        ...
        if (full_url.charAt(full_url.length - 1) == 'http://blog.hocmai.vn/') {
        ...
        return full_url.substring(0, full_url.lastIndexOf("http://blog.hocmai.vn/"))+ '/';
    ...
    get_mod_rewrite_pagination: function () {
        ...
        var last_url_parameter = full_url.substring(full_url.lastIndexOf("http://blog.hocmai.vn/")+1, full_url.length);
...
var Froogaloop=function(){function e(a){return new e.fn.init(a)}function h(a,c,b){if(!b.contentWindow.postMessage)return!1;var f=b.getAttribute("src").split("?")[0],a=JSON.stringify({method:a,value:c});"//"===f.substr(0,2)&&(f=window.location.protocol+f);b.contentWindow.postMessage(a,f)}function j(a){var c,b;try{c=JSON.parse(a.data),b=c.event||c.method}catch(f){}"ready"==b&&!i&&(i=!0);if(a.origin!=k)return!1;var a=c.value,e=c.data,g=""===g?null:c.player_id;c=g?d[g][b]:d[b];b=[];if(!c)return!1;void 0!==
    a&&b.push(a);e&&b.push(e);g&&b.push(g);return 0<b.length?c.apply(null,b):c.call()}function l(a,c,b){b?(d[b]||(d[b]={}),d[b][a]=c):d[a]=c}var d={},i=!1,k="";e.fn=e.prototype={element:null,init:function(a){"string"===typeof a&&(a=document.getElementById(a));this.element=a;a=this.element.getAttribute("src");"//"===a.substr(0,2)&&(a=window.location.protocol+a);for(var a=a.split("http://blog.hocmai.vn/"),c="",b=0,f=a.length;b<f;b++){if(3>b)c+=a[b];else break;2>b&&(c+="http://blog.hocmai.vn/")}k=c;return this},api:function(a,c){if(!this.element||
